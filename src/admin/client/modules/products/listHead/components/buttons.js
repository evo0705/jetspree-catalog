...
export default class Buttons extends React.Component {
  ...
  onProductUploadFilesClicked = () => {
    this.props.onProductUploadFilesClicked();
  };
  ...
  render() {
    ...
    return (
      <Fragment>
        ...
        {selectedCount > 0 &&
        <Fragment>
          <IconButton touch={true} tooltipPosition="bottom-left" tooltip={messages.actions_delete}
                      onClick={this.openDelete}>
            <FontIcon color="#fff" className="material-icons">delete</FontIcon>
          </IconButton>
          <IconButton touch={true} tooltipPosition="bottom-left" tooltip={messages.actions_moveTo}
          ...
          />
          <Dialog title={messages.actions_moveTo}
