...
import ProductBatchList from 'routes/products/batch/list'
import ProductBatchCreate from 'routes/products/batch/create'
import ProductBatchView from 'routes/products/batch/view'
      ...
      <div id="container">
        ...
        <div id="bodyContainer">
          <Switch>
            ...
            <Route path="/admin/products/batch" exact component={ProductBatchList}/>
            <Route path="/admin/products/batch/create" component={ProductBatchCreate}/>
            <Route path="/admin/products/batch/view/:batchId" component={ProductBatchView}/>
