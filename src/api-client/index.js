...
const Batches = require('./api/batches/batches')
const BatchCreateProducts = require('./api/batches/createProducts')
const BatchDeleteProducts = require('./api/batches/deleteProducts')
...
class Client {
  constructor(options) {
    ...
    this.batches.createProducts = new BatchCreateProducts(apiClient);
    this.batches.deleteProducts = new BatchDeleteProducts(apiClient);
